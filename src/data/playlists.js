...
export const PLAYLISTS = [
  {
    ...
    songs: [
      ...
      {
        id: "MxjYunZktDA",
        title: "Theher Ja (Acoustic)",
        artist: "Armaan Malik",
        movie: "Special Version",
        year: "2018",
        duration: "3:30",
        get cover() { return ytThumb(this.id); }
      },
  ...
  },
  {
    ...
    songs: [
      ...
      },
      {
        id: "go-j1EpaGVo",
        title: "Sun Saawariya",
        artist: "Accha Insaan, AtharvaMusic",
        movie: "Indie Single",
        year: "2026",
        duration: "3:30",
        get cover() { return ytThumb(this.id); }
      ...
      },
      {
        id: "b-gjLgT4SUQ",
        title: "Aashiqana",
        artist: "Chaar Diwaari, Indian Ocean",
        movie: "Indie Single",
        year: "2026",
        duration: "3:30",
        get cover() { return ytThumb(this.id); }
